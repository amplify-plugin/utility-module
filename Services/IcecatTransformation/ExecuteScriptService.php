...
namespace Amplify\System\Utility\Services\IcecatTransformation;
            ...
            if (preg_match_all('/"(?:\\\\.|[^\\\\"])*"|\S+/', $text, $tokens)) {
                ...
                switch (strtolower($tokens[0])) {
                    ...
                    case 'store':
                        ...
                        // Update attribute (or add)
                        //                         dump($attributes, $outputField, $inputFieldValue, $addMode);
                    ...
                    case 'convert_case':
                        ...
                        if (in_array(strtolower($inputField), $productFields, true)) {
                            $this->setValue($fields, $inputField, $newValue);
                        } else {
                            $this->setAttrValue($attributes, $inputField, $newValue, false, false, false);
                        }

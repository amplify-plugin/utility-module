...
use Amplify\System\Jobs\ContactPermissionsServiceJob;
 ...
 */
class ContactPermissionsService extends ImportService
{
    /**
     * @var mixed
     */
    ...
    public function __construct(ImportDefinition $importDefinition, $request)
    {
        ...
        $this->jobFullName = ContactPermissionsServiceJob::class;
    ...
    {
        echo '## ContactPermissionsService :: process() ##', PHP_EOL, PHP_EOL;
        ...
        $csvData->each(function ($aCsv) {
            ...
            ContactPermissionsServiceJob::dispatch($data)->delay(Carbon::now()->addSeconds($this->delay));

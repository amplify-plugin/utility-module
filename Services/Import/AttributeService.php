 ...
 */
class AttributeService extends ImportService
{
    /**
     * @var mixed
     */
    ...
    public function __construct(ImportDefinition $importDefinition, $request)
    {
        ...
        $this->jobFullName = AttributeServiceJob::class;
    ...
    public function process()
    {
        ...
        $csvData->each(function ($aCsv) {
            ...
            AttributeServiceJob::dispatch($data)->delay(Carbon::now()->addSeconds($this->delay));

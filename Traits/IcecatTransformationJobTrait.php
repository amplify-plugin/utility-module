...
trait IcecatTransformationJobTrait
{
    ...
    public function updateFailedJob(Request $request): ?JsonResponse
    {
        ...
        DBHelper::updateJobPayloadForIcecatTransformation($uuids, $updateImportData, $request->id);
    ...
    private function updateImportJob($id, $uuids)
    {
        ...
        $importJob = IcecatTransformation::query()->findOrFail($id);
        $importJob->failed_count = $importJob->failed_count - count($uuids);
        $importJob->save();

        // Delete existing errors
        IcecatTransformationError::query()->whereIn('uuid', $uuids)->delete();
    }
    ...
    public function getRetryImportJobData($isSaveAndRetry): ImportJobCrudController
    {
        ...
        $this->importJobInstance = IcecatTransformation::query();
    ...
    {
        // Getting UUIDs
        $this->importErrorInstance = IcecatTransformationError::query();
